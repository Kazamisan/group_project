...
<html>
    ...
    <body>
        ...
        Description:<br /><c:out value="${ticket.body}" /><br /><br />
        The current price:<br />$ <c:out value="${ticket.price}" /><br /><br />
        The time left:<br /><c:out value="${ticket.countdown}" /><br /><br />
        <a href="<c:url value="ticket/bid/"/>">I want to bid this item</a><br /><br />
